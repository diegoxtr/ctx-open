...
- La documentacion publica ahora describe la estrategia de release branches y el flujo de instalacion publico sin filtrar rutas locales ni URLs temporales del live demo.
