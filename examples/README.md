...
- `bootstrap-agriculture-demo/`: a dedicated cognitive repo for validating bootstrap map/apply against a complex agricultural systems article
- `bootstrap-agriculture-demo-v2/`: the second-pass version of the same agricultural contradiction case, focused on hypothesis isolation instead of early synthesis
- `bootstrap-agriculture-demo-v3/`: the implementation-validation repo that proves coexistence-first bootstrap behavior against the same contradiction-heavy article
- `bootstrap-agriculture-demo-v4/`: a fresh regression repo for validating branch-like hypothesis semantics on the same contradiction-heavy agricultural article
