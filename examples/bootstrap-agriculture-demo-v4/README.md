...
- [REAL_TESTING.md](REAL_TESTING.md)

This folder is initialized as its own CTX cognitive repository so the branch-semantics layer can be measured independently from `v1`, `v2`, and `v3`.
